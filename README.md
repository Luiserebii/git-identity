...
```
unzip git-identity-0.4.1-alpha.zip -d ~/
cd ~/git-identity-0.4.1-alpha
npm install
npm run build
sudo chmod u+x ~/git-identity-0.4.1-alpha/git-identity
sudo ln -s ~/git-identity-0.4.1-alpha/git-identity /usr/local/bin/git-identity
```
