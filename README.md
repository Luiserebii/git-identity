...
```
unzip git-identity-0.2.1.zip -d ~/
cd ~/git-identity-0.2.1
npm install
sudo chmod u+x ~/git-identity-0.2.1/git-identity
sudo ln -s ~/git-identity-0.2.1/git-identity /usr/local/bin/git-identity
```
